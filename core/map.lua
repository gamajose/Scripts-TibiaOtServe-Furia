...
-- @param ignoreMagicField (boolean) - If is true will consider tiles with magic field as walkable
-- @param ignoreMonsters (boolean) - If is true will consider tiles with monster as walkable
function Map.canWalk(x, y, z, ignoreBlockPath, ignoreMagicField, ignoreMonsters)
    return mapCanWalk(x, y, z, ignoreBlockPath, ignoreMagicField, ignoreMonsters)
end
